...
import static com.example.biuviewpagerlayoutmanager.MainActivity.INTENT_TITLE;
...
import com.example.biuviewpagerlayoutmanager.layoutmanager.ScrollHelper;
...
public abstract class BaseActivity<V extends ViewPagerLayoutManager, S extends SettingPopUpWindow>
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setTitle(getIntent().getCharSequenceExtra(INTENT_TITLE));
